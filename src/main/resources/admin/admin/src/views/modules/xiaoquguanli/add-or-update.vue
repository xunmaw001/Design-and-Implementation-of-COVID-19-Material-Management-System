               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="小区管理员姓名" prop="xiaoquguanliName">
                       <el-input v-model="ruleForm.xiaoquguanliName"
                                 placeholder="小区管理员姓名" clearable  :readonly="ro.xiaoquguanliName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="xiaoquguanliPhone">
                       <el-input v-model="ruleForm.xiaoquguanliPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.xiaoquguanliPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身份证号" prop="xiaoquguanliIdNumber">
                       <el-input v-model="ruleForm.xiaoquguanliIdNumber"
                                 placeholder="身份证号" clearable  :readonly="ro.xiaoquguanliIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="xiaoquguanliEmail">
                       <el-input v-model="ruleForm.xiaoquguanliEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.xiaoquguanliEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    xiaoquguanliName: false,
                    xiaoquguanliPhoto: false,
                    xiaoquguanliPhone: false,
                    xiaoquguanliIdNumber: false,
                    xiaoquguanliEmail: false,
                    sexTypes: false,
                    xiaoquguanliDelete: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   xiaoquguanliName: [
                              { required: true, message: '小区管理员姓名不能为空', trigger: 'blur' },
                          ],
                   xiaoquguanliPhoto: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xiaoquguanli/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xiaoquguanliCrossAddOrUpdateFlag = false;
                                        this.parent.search();
