        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="物资详情" prop="wuziContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziContent" label="物资详情" prop="wuziContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wuziContent: [
                              { required: true, message: '物资详情不能为空', trigger: 'blur' },
                          ],
                   wuziDelete: [
