               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="自愿者姓名" prop="zhiyaunzheName">
                       <el-input v-model="ruleForm.zhiyaunzheName"
                                 placeholder="自愿者姓名" clearable  :readonly="ro.zhiyaunzheName"></el-input>
                   </el-form-item>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhiyaunzhePhoto" label="头像" prop="zhiyaunzhePhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.zhiyaunzhePhoto?$base.url+ruleForm.zhiyaunzhePhoto:''"
                            @change="zhiyaunzhePhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="自愿者联系方式" prop="zhiyaunzhePhone">
                       <el-input v-model="ruleForm.zhiyaunzhePhone"
                                 placeholder="自愿者联系方式" clearable  :readonly="ro.zhiyaunzhePhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="自愿者身份证号" prop="zhiyaunzheIdNumber">
                       <el-input v-model="ruleForm.zhiyaunzheIdNumber"
                                 placeholder="自愿者身份证号" clearable  :readonly="ro.zhiyaunzheIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="zhiyaunzheEmail">
                       <el-input v-model="ruleForm.zhiyaunzheEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.zhiyaunzheEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="住址" prop="zhiyaunzheAddress">
                       <el-input v-model="ruleForm.zhiyaunzheAddress"
                                 placeholder="住址" clearable  :readonly="ro.zhiyaunzheAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="自愿者服务记录" prop="zhiyaunzheContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhiyaunzheContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhiyaunzheContent" label="自愿者服务记录" prop="zhiyaunzheContent">
                            <span v-html="ruleForm.zhiyaunzheContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    zhiyaunzheName: false,
                    zhiyaunzhePhoto: false,
                    zhiyaunzhePhone: false,
                    zhiyaunzheIdNumber: false,
                    zhiyaunzheEmail: false,
                    zhiyaunzheAddress: false,
                    sexTypes: false,
                    zhiyaunzheContent: false,
                    zhiyaunzheDelete: false,
                },
                ruleForm: {
                    zhiyaunzheName: '',
                    zhiyaunzhePhoto: '',
                ...
                rules: {
                   ...
                   zhiyaunzhePhone: [
                              {  required: true, message: '自愿者联系方式不能为空', trigger: 'blur' },
                   ...
                   zhiyaunzheIdNumber: [
                              { required: true, message: '自愿者身份证号不能为空', trigger: 'blur' },
                   ...
                   zhiyaunzheContent: [
                              { required: true, message: '自愿者服务记录不能为空', trigger: 'blur' },
                          ],
                   zhiyaunzheDelete: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.zhiyaunzheContent = _this.ruleForm.zhiyaunzheContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.zhiyaunzheContent = this.ruleForm.zhiyaunzheContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`zhiyaunzhe/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhiyaunzheCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            zhiyaunzhePhotoUploadChange(fileUrls){
                this.ruleForm.zhiyaunzhePhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
