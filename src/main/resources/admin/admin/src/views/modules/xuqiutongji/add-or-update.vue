    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zhiyaunzheId" name="zhiyaunzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="居民" prop="xuqiutongjiName">
                       <el-input v-model="ruleForm.xuqiutongjiName"
                                 placeholder="居民" clearable  :readonly="ro.xuqiutongjiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="居民" prop="xuqiutongjiName">
                           <el-input v-model="ruleForm.xuqiutongjiName"
                                     placeholder="居民" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="xuqiutongjiPhone">
                       <el-input v-model="ruleForm.xuqiutongjiPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.xuqiutongjiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="xuqiutongjiPhone">
                           <el-input v-model="ruleForm.xuqiutongjiPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="住址" prop="xuqiutongjiAddress">
                       <el-input v-model="ruleForm.xuqiutongjiAddress"
                                 placeholder="住址" clearable  :readonly="ro.xuqiutongjiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="住址" prop="xuqiutongjiAddress">
                           <el-input v-model="ruleForm.xuqiutongjiAddress"
                                     placeholder="住址" readonly></el-input>
                       </el-form-item>
                   </div>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="需求详情" prop="xuqiutongjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xuqiutongjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xuqiutongjiContent" label="需求详情" prop="xuqiutongjiContent">
                            <span v-html="ruleForm.xuqiutongjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    zhiyaunzheId: false,
                    xuqiutongjiName: false,
                    xuqiutongjiPhone: false,
                    xuqiutongjiAddress: false,
                    xuqiutongjiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    zhiyaunzheId: '',
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `xuqiutongji/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.zhiyaunzheChange(data.data.zhiyaunzheId)
                        _this.ruleForm.xuqiutongjiContent = _this.ruleForm.xuqiutongjiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.xuqiutongjiContent = this.ruleForm.xuqiutongjiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`xuqiutongji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xuqiutongjiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
