    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xiaoquguanliId" name="xiaoquguanliId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="调用数量" prop="wuzidiaopeiNumber">
                       <el-input v-model="ruleForm.wuzidiaopeiNumber"
                                 placeholder="调用数量" clearable  :readonly="ro.wuzidiaopeiNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="调用数量" prop="wuzidiaopeiNumber">
                           <el-input v-model="ruleForm.wuzidiaopeiNumber"
                                     placeholder="调用数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="wuzidiaopeiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuzidiaopeiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuzidiaopeiContent" label="备注" prop="wuzidiaopeiContent">
                            <span v-html="ruleForm.wuzidiaopeiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    wuzidiaopeiNumber: false,
                    wuzidiaopeiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    wuziId: '',
                ...
                rules: {
                   ...
                   wuzidiaopeiNumber: [
                              { required: true, message: '调用数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wuzidiaopeiContent = _this.ruleForm.wuzidiaopeiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wuzidiaopeiContent = this.ruleForm.wuzidiaopeiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`wuzidiaopei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuzidiaopeiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
