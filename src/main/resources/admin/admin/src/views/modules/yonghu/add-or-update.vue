               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="采购员姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="采购员姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="采购员手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="采购员手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="采购员身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="采购员身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所在单位" prop="yonghuDanwei">
                       <el-input v-model="ruleForm.yonghuDanwei"
                                 placeholder="所在单位" clearable  :readonly="ro.yonghuDanwei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuPhone: [
                              {  required: true, message: '采购员手机号不能为空', trigger: 'blur' },
                   ...
                   yonghuIdNumber: [
                              { required: true, message: '采购员身份证号不能为空', trigger: 'blur' },
