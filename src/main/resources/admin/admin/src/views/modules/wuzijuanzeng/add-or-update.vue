    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xiaoquguanliId" name="xiaoquguanliId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="捐赠人" prop="wuzijuanzengName">
                       <el-input v-model="ruleForm.wuzijuanzengName"
                                 placeholder="捐赠人" clearable  :readonly="ro.wuzijuanzengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="捐赠人" prop="wuzijuanzengName">
                           <el-input v-model="ruleForm.wuzijuanzengName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="wuzijuanzengPhone">
                       <el-input v-model="ruleForm.wuzijuanzengPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.wuzijuanzengPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="wuzijuanzengPhone">
                           <el-input v-model="ruleForm.wuzijuanzengPhone"
                                     placeholder="联系方式" readonly></el-input>
                       </el-form-item>
                   </div>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="捐赠人住址" prop="wuzijuanzengAddress">
                       <el-input v-model="ruleForm.wuzijuanzengAddress"
                                 placeholder="捐赠人住址" clearable  :readonly="ro.wuzijuanzengAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="捐赠人住址" prop="wuzijuanzengAddress">
                           <el-input v-model="ruleForm.wuzijuanzengAddress"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="wuzijuanzengContent">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    wuzijuanzengPhone: false,
                    wuzijuanzengAddress: false,
