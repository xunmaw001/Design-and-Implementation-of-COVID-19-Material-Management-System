    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="wuziId" name="wuziId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派发居民" prop="wuzipaifaName">
                       <el-input v-model="ruleForm.wuzipaifaName"
                                 placeholder="派发居民" clearable  :readonly="ro.wuzipaifaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派发居民" prop="wuzipaifaName">
                           <el-input v-model="ruleForm.wuzipaifaName"
                                     placeholder="派发居民" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="wuzipaifaPhone">
                       <el-input v-model="ruleForm.wuzipaifaPhone"
                                 placeholder="联系方式" clearable  :readonly="ro.wuzipaifaPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="wuzipaifaPhone">
                           <el-input v-model="ruleForm.wuzipaifaPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派发住址" prop="wuzipaifaAddress">
                       <el-input v-model="ruleForm.wuzipaifaAddress"
                                 placeholder="派发住址" clearable  :readonly="ro.wuzipaifaAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派发住址" prop="wuzipaifaAddress">
                           <el-input v-model="ruleForm.wuzipaifaAddress"
                                     placeholder="派发住址" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派发数量" prop="wuzipaifaNumber">
                       <el-input v-model="ruleForm.wuzipaifaNumber"
                                 placeholder="派发数量" clearable  :readonly="ro.wuzipaifaNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派发数量" prop="wuzipaifaNumber">
                           <el-input v-model="ruleForm.wuzipaifaNumber"
                                     placeholder="派发数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="wuzipaifaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuzipaifaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuzipaifaContent" label="备注" prop="wuzipaifaContent">
                            <span v-html="ruleForm.wuzipaifaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    wuziId: false,
                    wuzipaifaName: false,
                    wuzipaifaPhone: false,
                    wuzipaifaAddress: false,
                    wuzipaifaNumber: false,
                    wuzipaifaContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    zhiyaunzheId: '',
                ...
                rules: {
                   ...
                   wuzipaifaName: [
                              { required: true, message: '派发居民不能为空', trigger: 'blur' },
                          ],
                   wuzipaifaPhone: [
                   ...
                   wuzipaifaAddress: [
                              { required: true, message: '派发住址不能为空', trigger: 'blur' },
                          ],
                   wuzipaifaNumber: [
                              { required: true, message: '派发数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wuzipaifaContent = _this.ruleForm.wuzipaifaContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wuzipaifaContent = this.ruleForm.wuzipaifaContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`wuzipaifa/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuzipaifaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
