    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者采购员手机号或者采购员身份证号已经被使用");
        }
    }
...
//                            yonghuEntity.setYonghuName(data.get(0));                    //采购员姓名 要改的
//                            yonghuEntity.setYonghuPhoto("");//详情和图片
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //采购员手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //采购员身份证号 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //邮箱 要改的
//                            yonghuEntity.setYonghuDanwei(data.get(0));                    //单位 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [采购员手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //采购员身份证号
                        ...
                        if(yonghuEntities_yonghuIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [采购员身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "采购员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","采购员");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者采购员手机号或者采购员身份证号已经被使用");
        yonghu.setYonghuDelete(1);
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
