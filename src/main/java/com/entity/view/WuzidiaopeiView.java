...
public class WuzidiaopeiView extends WuzidiaopeiEntity implements Serializable {
	...
	public WuzidiaopeiView() {

	}

	public WuzidiaopeiView(WuzidiaopeiEntity wuzidiaopeiEntity) {
		try {
			BeanUtils.copyProperties(this, wuzidiaopeiEntity);
